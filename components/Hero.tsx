...
const Hero: React.FC<HeroProps> = ({ lang }) => {
  ...
  // Construimos una URL absoluta para asegurar compatibilidad en móviles
  const cvPath = `${window.location.origin}/${l.cvFile}`;
      ...
      <div className="max-w-6xl mx-auto text-center flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-20">
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-8 py-4 bg-slate-900 text-white border border-slate-900 rounded-2xl hover:bg-indigo-600 hover:border-indigo-600 hover:shadow-2xl transition-all font-bold active:scale-95 shadow-lg shadow-slate-200"
          >
